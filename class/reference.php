...
{
	$html = "<a name=\"detact\" id=\"bestkeeperAnchor\">&nbsp;</a><table id='bestkeeper'><tr align='center'><td colspan='".($this->genesNumber+1)."'>CP data of housekeeping Genes by BEST KEEPER</td></tr><tr><td>&nbsp;&nbsp;</td>"; 
	...
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".$this->treatmentNumber."</td>";
	}   
	$html .= "</tr>";
 
	
	//geo Mean [CP]
	$html .= "<tr><td>geo Mean [CP]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkGeomena[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";

	//ar Mean [CP]
	$html .= "<tr><td>AR Mean [CP]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkarmena[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";	
	
	
    //min [CP]
	$html .= "<tr><td>min [CP]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkMin[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";	
	
    //min [CP]
	$html .= "<tr><td>max [CP]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkMax[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";	

	    //std dev [�� CP]
	$html .= "<tr style='color: #0000FF'><td>std dev [+/- CP]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkStdDev[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";	
	...
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{   
	$html .= "<td>".number_format($this->bkCV[$gene], 2, '.', '')."</td>";
	}   
	$html .= "</tr>"; 

		    //min [x-fold]
	$html .= "<tr><td>min [x-fold]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkMinxFold[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>"; 
	
		    //max [x-fold]
	$html .= "<tr><td>max [x-fold]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkMaxFold[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";
 
    //max [x-fold]
	$html .= "<tr><td>std dev [+/- x-fold]</td>"; 
	for($gene =0; $gene< $this->genesNumber;$gene++)
	{
	$html .= "<td>".number_format($this->bkStdFold[$gene],2, '.', '')."</td>";
	}   
	$html .= "</tr>";	
    $html .= "</table>";	
	...
	//BEST KEEPER
$html .= "<br/><br/><table id='bestkeeper'><tr align='center'><td colspan='".($this->genesNumber+1)."'> Pearson correlation coefficient ( r ) by BEST KEEPER</td></tr><tr><td>&nbsp;&nbsp;</td>"; 
	foreach ($this->expression[0] as $k)
	{ 
	  $html .= "<td>".$k."</td>";
	}   
   ...
   for($gene1 =1; $gene1< $this->genesNumber;$gene1++)	
   {
	  ...
	  else
	  {
	    ...
	    $html .= "<tr ". $style."><td>".$this->expression[0][$gene1]."</td>"; 
       for($gene2 =0; $gene2< $this->genesNumber;$gene2++)	
       {
		 ...
		 {
          $html .= "<td>".number_format($this->bkcompareValue[$gene2][$gene1] ,3, '.', '')."</td>"; 
		  }
       }	   
	   $html .= "</tr>";
		
	    $html .= "<tr ". $style."><td>p-value</td>"; 
       for($gene2 =0; $gene2< $this->genesNumber;$gene2++)	
       {
		 ...
		 { 
		   ...
		   {
		     $html .= "<td>".number_format($this->bkcomparePValue[$gene2][$gene1] ,3, '.', '')."</td>"; 
		   }
		  }
       }	   
	   $html .= "</tr>";	
...
$html .= "</table>";
   ...
   $html .= "<br/><br/><table id='bestkeeper'><tr align='center'><td colspan='".($this->genesNumber+1)."'>Pearson correlation coefficient ( r )</td></tr><tr><td>BestKeeper  vs.</td>"; 
	foreach ($this->expression[0] as $k)
	{ 
	  $html .= "<td>".$k."</td>";
	}   
      ...
      $html .= "<tr><td>coeff. of corr. [r]</td>"; 
       for($gene =0; $gene< $this->genesNumber;$gene++)	
       {
		 ...
		 { 
		   ...
		   {
		     $html .= "<td>".number_format($this->bkcompareBKValue[$gene]  ,3, '.', '')."</td>"; 
		   }
		  }
       }	   
	   $html .= "</tr>";	
	   
      $html .= "<tr><td>p-value</td>"; 
       for($gene =0; $gene< $this->genesNumber;$gene++)	
       {
		 ...
		 { 
		   ...
		   {
		     $html .= "<td>".number_format($this->bkcompareBKPValue[$gene]  ,3, '.', '')."</td>"; 
		   }
		  }
       }	   
	   $html .= "</tr>";     
